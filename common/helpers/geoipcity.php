...
class Geoipcity //extends ActiveFixture
{
    public static function getrecordwithdnsservice($str)
    {
    ...
    public static function _get_record_v6($gi, $ipnum)
    {
    ...
    public static function _common_get_record($gi, $seek_country)
    {
    ...
    public static function GeoIP_record_by_addr_v6($gi, $addr)
    {
        if ($addr == null) {
            return 0;
        }
    ...
    public static function _get_record($gi, $ipnum)
    {
    ...
    public static function GeoIP_record_by_addr($gi, $addr)
    {
        if ($addr == null) {
            return 0;
        }
